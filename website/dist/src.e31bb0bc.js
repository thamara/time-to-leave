...
},{"./images/herobg.svg":[["herobg.a069a824.svg","images/herobg.svg"],"images/herobg.svg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"js/scrollreveal.js":[function(require,module,exports) {
"use strict";
...
var ScrollReveal = function ScrollReveal() {
  ...
  var reveal = _gsap.gsap.utils.toArray('.js-reveal');

  reveal.forEach(function (text, i) {
    ScrollTrigger.create({
      ...
      onEnter: function onEnter() {
        return text.classList.add('shown');
      },
      onLeaveBack: function onLeaveBack() {
        return text.classList.remove('shown');
      }
    });
  });
};
...
var _scrollreveal = _interopRequireDefault(require("./js/scrollreveal.js"));
...
if (document.querySelectorAll('img')) {
  (0, _imagesloaded.default)(document.querySelectorAll('img'), function () {
    ...
    setTimeout(function () {
      var scrollReveal = new _scrollreveal.default();
    }, 100);
  });
} // customization tl
...
tl.addLabel("start").from(".js-customization-image--3", {
  x: 0,
  y: 0
}).from(".js-customization-image--2", {
  x: 0,
  y: 0
}, "-=.3").addLabel("end"); // notification tl
...
nt.addLabel("start").from(".js-notification-image--2", {
  x: 0,
  y: 0
}).addLabel("end"); // daysoff tl

var dt = gsap.timeline({
  scrollTrigger: {
...
document.getElementById('js-dropdown').addEventListener('click', function (e) {
  e.preventDefault();
  var dropdown = e.target.nextSibling.nextSibling;
...
},{"./styles.scss":"styles.scss","./js/scrollreveal.js":"js/scrollreveal.js","imagesloaded":"../node_modules/imagesloaded/imagesloaded.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
